...
class studentSignalsTest(TestCase):
    def setUp(self):
    ...
    def testing_on_user_creation(self):
    ...
    @patch("website.models.log")
    def testing_no_signal_on_user_update(self, mock):
    ...
    @patch("website.models.log")
    def testing_both_user_photo_delete(self, mock):
...
class professorSingalsTest(TestCase):
    def setUp(self):
        self.test_user = User.objects.create_user(username="test", password="test")
        self.test_uni = university.objects.create(name="test", code=200, address="test address")
    ...
    @patch("website.models.log")
    def testing_no_signals_on_user_update(self, mock):
...
class lessonSignalsTest(TestCase):
    def setUp(self):
        self.test_major = major.objects.create(name="test", code=100, capacity=300)
        self.data = {
            "name":"test lesson",
    ...
    def testing_on_lesson_creation(self):
    ...
    @patch("website.models.log")
    def testing_no_signal_on_lesson_update(self, mock):
...
class lesson_classSiganlTest(TestCase):
    def setUp(self):
        # ? creating university
        self.test_uni = university.objects.create(name="test", code=200, address="test address")
    ...
    def testing_on_lesson_class_creation(self):
    ...
    @patch("website.models.log")
    def testing_no_signal_on_lesson_class_update(self, mock):
